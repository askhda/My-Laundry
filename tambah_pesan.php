...
<body>
	...
	<main>
		...
		<div class="container-sm my-5">
			<h1 class="text-center">Tambah Data Pesan</h1>
			<br><br>
			<div class="card mx-auto" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px; width: 75%;">
			  <div class="card-body m-4">
			    <form method="POST" name="form-tambah-pelanggan" action="action_tambah_pesan.php">
			    	<div class="sm-3">
					  <label for="exampleFormControlInput1" class="form-label">ID Pesan</label>
					...
					<div class="sm-3">
					  ...
					  <input type="number" name="berat-pesanan" class="form-control">
					</div>
					<br>
					<!----
					<div class="sm-3">
