...
<body>
	...
	$pelanggans = mysqli_query($conn, "SELECT * FROM pelanggan WHERE id = '$idPelanggan'");
			  ...
			  <div class="card-body m-4">
			    <form method="POST" name="form-edit-pelanggan" action="">
			    	<div class="sm-3">
					  ...
					  <input type="number" class="form-control" id="exampleFormControlInput1" name="id-pelanggan" value="<?php echo $idPelanggan;?>" disabled>
					</div>
					<br>
					<div class="sm-3">
					  <label for="exampleFormControlTextarea1" class="form-label">Nama</label>
					  <input type="text" name="nama-pelanggan" class="form-control" value="<?php echo $namaPelanggan;?>">
					</div>
					<br>
					<div class="sm-3">
					  <label for="exampleFormControlTextarea1" class="form-label">Alamat</label>
					  <textarea class="form-control" id="exampleFormControlTextarea1" name="alamat-pelanggan" rows="3"><?php echo $alamatPelanggan;?></textarea>
					</div>
					<br>
					<div class="sm-3">
					  <label for="exampleFormControlInput1" class="form-label">No. WhatsApp</label>
					  <input type="number" class="form-control" id="exampleFormControlInput1" maxlength="12" pattern="\d" onKeyPress="if(this.value.length==12){return false;}" name="no-wa" value="<?php echo $noWa;?>">
					</div>
					<br><br>
	...
	if (isset($_POST['submit'])) {
		...
		$updateDataPelanggan = "UPDATE pelanggan SET nama='$NamaPelanggan', alamat='$AlamatPelanggan', nowa='$NoWa' WHERE id='$idPelanggan'";
		if (mysqli_query($conn, $updateDataPelanggan)==true) {
